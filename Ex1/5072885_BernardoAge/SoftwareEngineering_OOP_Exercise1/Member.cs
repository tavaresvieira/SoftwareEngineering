...
public class Member
{
    ...
    public static int TotalMembers
    {
        ...
        private set { totalMembers = value; }
    }
    ...
    public static int TotalBooksBorrowed
    {
        ...
        set
        {
            ...
            if(value < 0) totalBooksBorrowed = 0;
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        if (MembershipLevel == "Standard") return standardMax;
        if (MembershipLevel == "Premium") return premiumMax;
        if (MembershipLevel == "VIP") return vipMax;
        return 0;
    ...
    public void BorrowBook()
    {
        ...
        if (booksBorrowed < max) { booksBorrowed++; totalBooksBorrowed++; } 
        else Console.WriteLine($"{Name} has reached their borrowing limit.");
    }
    ...
    public void ReturnBook()
    {
        ...
        if (booksBorrowed <= 0) Console.WriteLine($"{Name} has returned all their books.");
        else { booksBorrowed--; totalBooksBorrowed--; }
    }
